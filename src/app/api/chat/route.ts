...
Given a prompt describing a desired vibe for a song, please respond with parameters for both synthesizers in JSON to match the prompt. Additionally, include a four chord progression, scale name and root note. Include a melody that will be played across two bars. Each melody step represents a 16th note, and are 0-indexed. Melody steps include the start and end step plus the note including the octave (e.g. C#4).
